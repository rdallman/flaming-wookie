...
func main() {
	...
	r.HandleFunc("/dashboard/classes/{cid:[0-9]+}/quiz", handleQuizCreate).Methods("POST")
	...
	r.HandleFunc("/dashboard/classes/{cid:[0-9]+}/student", handleAddStudents).Methods("POST")
